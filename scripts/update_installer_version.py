...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TransientVisualizer Demo Installer\n"
      else:
        line="OutputBaseFilename=TransientVisualizer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TransientVisualizer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TransientVisualizer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TransientVisualizer Demo installer\n"
     else:
       line="SetupWindowTitle=TransientVisualizer installer\n"
