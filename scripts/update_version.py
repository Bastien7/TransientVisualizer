...
def main():
  ...
  plistpath = scriptpath + "/resources/TransientVisualizer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TransientVisualizer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TransientVisualizer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TransientVisualizer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TransientVisualizer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/TransientVisualizer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TransientVisualizer.iss",inplace=1):
