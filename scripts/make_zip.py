...
def  main():
  ...
  installer = "\installer\TransientVisualizer Installer.exe"
   
  if demo:
    installer = "\installer\TransientVisualizer Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\TransientVisualizer manual.pdf" 
  ]
  ...
  ZIPNAME = "TransientVisualizer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "TransientVisualizer-v" + FULLVERSIONSTR + "-win-demo.zip"
